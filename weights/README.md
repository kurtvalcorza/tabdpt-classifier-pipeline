...
# Option 3: the package helpers (manifest-driven; fetches only what is absent)
python -c "from tabdpt_classifier_pipeline import stage_missing_files, verify_snapshot; print(stage_missing_files(allow_download=True)); print(verify_snapshot()['files'])"
```
